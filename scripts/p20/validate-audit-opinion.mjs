...
try {
  ...
  assert(summary.resolved_slots === 2868, `expected 2,868 resolved slots after audit tranche, got ${summary.resolved_slots}`);
  ...
  console.log('P20_AUDIT_COMPLETENESS_OK resolved=2868 p20_remaining=517');
} catch (error) {
