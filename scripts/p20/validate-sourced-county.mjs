...
try {
  ...
  assert(summary.resolved_slots === 2915, `expected 2,915 resolved slots after P20 audit tranche, got ${summary.resolved_slots}`);
  ...
  console.log('P20_COMPLETENESS_OK resolved=2915 p20_remaining=470');
