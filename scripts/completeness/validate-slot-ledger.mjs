...
assert(p23ConstituencyTurnoutUnavailable.length===103,`P23 constituency turnout closure must contribute exactly 103 governed official-unavailable states, got ${p23ConstituencyTurnoutUnavailable.length}`);
...
assert(officialUnavailable.length===5744,`official-unavailable evidence inventory must reconcile 48 legacy + 66 P22 + 580 P23 census + 580 P23 evidence gaps + 103 P23 constituency turnout + 1450 P24 ward census + 1450 P24 ward evidence gaps + 1450 P24 ward turnout + 17 P24 ward MCA identity = 5744, got ${officialUnavailable.length}`);
