...
const ind=inds.find(i=>i.indicator_code==='IND-NG-CDF-ALLOCATION');if(!ind||ind.lifecycle_status!=='active')fail('allocation indicator not active');
...
if(oo.some(o=>o.badge!=='B'||o.geographic_method!=='aggregated'||o.source_class!=='official'||!Number.isFinite(o.value)))fail('allocation observations must be numeric official-derived B-badge values using the canonical aggregated geographic method');
