...
assert(fields.registered_voters?.verified_value === 31334 && fields.total_valid_votes?.verified_value === 21224 && fields.rejected_ballots?.verified_value === 81, 'fresh visual values changed');
...
assert(denom.governed_registered_voters === 31334 && denom.form_printed_registered_voters === 31334 && denom.registered_voters_reconciles === true, 'denominator must remain reconciled');
