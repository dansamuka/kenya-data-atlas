...
function finalize(){
  ...
  docs=docs.slice(0,p13Start)+section+docs.slice(p14Start);
  docs=docs.replace('## P14 — Action & Opportunity Finder Beta\n\n**Status: planned.**','## P14 — Action & Opportunity Finder Beta\n\n**Status: next.**\n\nRecommended next-session instruction: **Complete P14** from `data/project-roadmap.json`. Do not restart completed phases; implement the full Beta action layer and run its acceptance checks.');
  fs.writeFileSync('docs/REPO-COMPLETION-PLAN.md',docs);

  let p13Doc=fs.readFileSync('docs/P13-COUNTY-EVIDENCE-HUB.md','utf8');
  p13Doc=p13Doc.replace('**Status: implementation candidate.**','**Status: complete.**');
  fs.writeFileSync('docs/P13-COUNTY-EVIDENCE-HUB.md',p13Doc);
