...
try{
  ...
  // No peer group may itself carry a value judgement: the definition must
  // ship its own disclaimer, and tier labels must not use quality language.
  ...
  // Spot-check a specific, known-directional metric end to end so the
  // gate fails loudly if the direction rule or the mart wiring regresses.
