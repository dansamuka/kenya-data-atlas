...
const indicatorReleaseSeed = [
  ...
  { code:'REL-EPRA-FUEL-AUG2026', dataset:'DS-EPRA-FUEL-HEADLINE', title:'EPRA maximum retail fuel prices, 15 August - 14 September 2026', discovered_at:'2026-08-26T00:00:00Z', published_at:'2026-08-14', ref_start:'2026-08-15', ref_end:'2026-09-14', url:'https://www.epra.go.ke/pump-price-formulae', status:'published', version:'', notes:'Super Petrol maximum retail price: Nairobi KES 214.03/L, Mombasa KES 210.87/L. Diesel fell KES 5/L in this cycle; not yet loaded.' }
];
